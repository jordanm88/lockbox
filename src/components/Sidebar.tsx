          ...
          return (
            <button
              ...
              className={`flex items-center gap-3 rounded-full px-4 py-2.5 text-left text-sm font-medium transition-colors ${
                isActive ? "bg-blue-50 dark:bg-blue-950/40 text-blue-700 dark:text-blue-400" : "text-slate-600 hover:bg-slate-100"
              }`}
            >
      ...
      <div className="shrink-0 border-t border-slate-200">
        ...
        <div className="px-4 pt-3">
          <button
            ...
            className="flex w-full items-center justify-center gap-1.5 rounded-full border border-dashed border-amber-200 dark:border-amber-800/60 bg-amber-50 dark:bg-amber-950/40 py-2 text-xs font-semibold text-amber-700 dark:text-amber-400 transition-colors hover:bg-amber-100 dark:hover:bg-amber-900/40"
          >
            💛 Fund the project
          </button>
        </div>
        {ejectStatus && (
          <p className="mx-4 mt-2 rounded-lg bg-blue-50 dark:bg-blue-950/40 px-3 py-2 text-xs font-medium text-blue-700 dark:text-blue-400">
            {ejectStatus}
          </p>
        )}
        <div className="flex flex-col gap-2 px-4 pb-4 pt-1">
          <button
            ...
            className="flex w-full items-center justify-center gap-2 rounded-full border border-slate-200 py-2.5 text-sm font-semibold text-slate-600 transition-colors hover:border-red-200 dark:hover:border-red-800/60 hover:bg-red-50 dark:hover:bg-red-950/40 hover:text-red-600 dark:hover:text-red-400"
          >
            🔒 Lock Vault
          </button>
          <button
            ...
            disabled={ejecting}
            className="flex w-full items-center justify-center gap-2 rounded-full border border-slate-200 py-2.5 text-sm font-semibold text-slate-600 transition-colors hover:border-blue-200 dark:hover:border-blue-800/60 hover:bg-blue-50 dark:hover:bg-blue-950/40 hover:text-blue-600 dark:hover:text-blue-400 disabled:opacity-60"
          >
